...
*/
public class Country implements Measurable, Comparable //we need comparable interface declare here to work with compareTo()
{
    private String name;
    private double area;
    ...
    */
    ...
    public int compareTo(Object otherObject)
    {
        ...
        // Return 0 if the two countries are equal. Use .equals method
